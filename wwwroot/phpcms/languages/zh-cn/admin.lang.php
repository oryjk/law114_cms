...
//index
$LANG['admin_site_title'] = 'BDCMS - 后台管理中心';
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将bdcms目录设置为644（linux/unix）或只读（NT）';
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.cdbaidu.com/';
$LANG['domain_end_string'] = '格式应该为http://www.cdbaidu.com/，请以‘/’结束';
...
$LANG['ismenu'] = '是否在导航显示';
$LANG['isindexguide'] = '是否为首页导航';
$LANG['isindexcol'] = '是否在首页展示';
$LANG['manage_sub_category'] = '管理子栏目';

//pw 2013/7/3添加
$LANG['contact_method'] = '联系方式';
$LANG['contact_phone_no'] = '电话号码';
$LANG['contact_msg_no'] = '短信号码';
$LANG['map_address'] = '地图地址';
$LANG['map_address_tag'] = '标注信息';
$LANG['contact_zixun'] = '在线咨询';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.cdbaidu.com/';
$LANG['site_domain_ex2'] = '格式应该为http://www.cdbaidu.com/，请以‘/’结束';
