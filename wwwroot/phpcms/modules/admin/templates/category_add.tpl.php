...
<tr>
     <th><?php echo L('ismenu');?>：</th>
      <td>
      <input type='radio' name='info[ismenu]' value='2' checked> 右侧&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--    <tr>
        <th><?php echo L('isindexguide');?>：</th>
        <td>
            <input type='radio' name='info[isindexguide]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='info[isindexguide]' value='0'  > <?php echo L('no');?>（字段名：isindexguide）</td>
    </tr>
    <tr>
        <th><?php echo L('isindexcol');?>：</th>
        <td>
            <input type='radio' name='info[isindexcol]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='info[isindexcol]' value='0'  > <?php echo L('no');?>（字段名：isindexcol）</td>
    </tr>-->
</table>
...
<tr>
  <th width="200"><?php echo L('available_styles');?>：</th>
        <td>
		<?php echo form::select($template_list, SITE_TPL, 'name="setting[template_list]" id="template_list" onchange="load_file_list(this.value)"', L('please_select'))?> 
		</td>
</tr>
		<tr>
...
<table width="100%" >
        ...
        <td>
			<table width="100%" class="table-list">
			  <thead>
				<tr>
				  <th align="left"><?php echo L('role_name');?></th><th><?php echo L('view');?></th><th><?php echo L('add');?></th><th><?php echo L('edit');?></th><th><?php echo L('delete');?></th><th><?php echo L('listorder');?></th><th><?php echo L('push');?></th><th><?php echo L('move');?></th><th><?php echo L('remove');?></th>
			  </tr>
			    </thead>
				 <tbody>
				<?php
				...
				?>
				  ...
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="init,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="add,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="edit,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="delete,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="listorder,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="push,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="move,<?php echo $roleid;?>" ></td>
				  <td align="center"><input checked="checked" type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> value="remove,<?php echo $roleid;?>" ></td>
			  </tr>
			  <?php }?>
