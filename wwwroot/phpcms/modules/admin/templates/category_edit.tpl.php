...
<table width="100%" class="table_form ">
	...
	<tr>
     <th><?php echo L('ismenu');?>：</th>
      <td>
      <input type='radio' name='info[ismenu]' value='2' <?php if($ismenu==2) echo 'checked';?>> 右侧&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--    <tr>
        ...
        <td>
            <input type='radio' name='info[isindexguide]' value='1' <?php if($isindexguide) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='info[isindexguide]' value='0' <?php if(!$isindexguide) echo 'checked';?>> <?php echo L('no');?>（字段名：isindexguide）</td>
    </tr>
    <tr>
        <th><?php echo L('isindexcol');?>：</th>
        <td>
            <input type='radio' name='info[isindexcol]' value='1' <?php if($isindexcol) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type='radio' name='info[isindexcol]' value='0' <?php if(!$isindexcol) echo 'checked';?>> <?php echo L('no');?>（字段名：isindexcol）</td>
    </tr>-->
</table>
...
<tr>
  <th width="200"><?php echo L('available_styles');?>：</th>
        <td>
		<?php echo form::select($template_list, isset($setting['template_list'])?$setting['template_list']:SITE_TPL, 'name="setting[template_list]" id="template_list" onchange="load_file_list(this.value)"', L('please_select'))?> 
		</td>
</tr>
		<tr>
			...
			<table width="100%" class="table-list">
			  <thead>
				...
				?>
				  ...
				  <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('remove',$roleid);?> value="remove,<?php echo $roleid;?>" ></td>
			  </tr>
			  <?php }?>
